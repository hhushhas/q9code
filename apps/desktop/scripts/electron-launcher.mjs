// This file mostly exists because we want dev mode to say "Q9 Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Q9 Code (Dev)" : "Q9 Code (Alpha)";
const APP_BUNDLE_ID = "com.hhushhas.q9code";

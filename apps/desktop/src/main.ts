...
const BASE_DIR =
  process.env.Q9CODE_HOME?.trim() ||
  process.env.T3CODE_HOME?.trim() ||
  Path.join(OS.homedir(), ".q9");
const STATE_DIR = Path.join(BASE_DIR, "userdata");
const DESKTOP_SCHEME = "t3";
const ROOT_DIR = Path.resolve(__dirname, "../../..");
const isDevelopment = Boolean(process.env.VITE_DEV_SERVER_URL);
const APP_BASE_NAME = "Q9 Code";
const APP_STAGE_LABEL = isDevelopment ? "Dev" : "Alpha";
const APP_DISPLAY_NAME = `${APP_BASE_NAME} (${APP_STAGE_LABEL})`;
const APP_USER_MODEL_ID = "com.hhushhas.q9code";
const LINUX_DESKTOP_ENTRY_NAME = isDevelopment ? "q9code-dev.desktop" : "q9code.desktop";
const LINUX_WM_CLASS = isDevelopment ? "q9code-dev" : "q9code";
const USER_DATA_DIR_NAME = isDevelopment ? "q9code-dev" : "q9code";

  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10 text-foreground sm:px-6">
      <div className="pointer-events-none absolute inset-0 opacity-90">
        <div className="theme-shell-glow-warning absolute inset-x-0 top-0 h-56" />
        <div className="theme-shell-gradient absolute inset-0" />
      </div>

      <section className="theme-shell-card relative w-full max-w-xl rounded-[1.75rem] border border-border/80 bg-card/92 p-6 shadow-2xl shadow-black/20 backdrop-blur-md sm:p-8">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="theme-shell-chip rounded-2xl border border-border/70 bg-background/80 p-3 text-foreground shadow-sm">

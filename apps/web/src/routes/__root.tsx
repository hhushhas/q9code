  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10 text-foreground sm:px-6">
      <div className="pointer-events-none absolute inset-0 opacity-80">
        <div className="theme-shell-glow-error absolute inset-x-0 top-0 h-44" />
        <div className="theme-shell-gradient absolute inset-0" />
      </div>

      <section className="theme-shell-card relative w-full max-w-xl rounded-2xl border border-border/80 bg-card/90 p-6 shadow-2xl shadow-black/20 backdrop-blur-md sm:p-8">
